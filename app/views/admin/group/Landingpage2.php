<?php require_once __DIR__ . '/../../components/header2.php'; ?>
...
<body>
    ...
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-8">
        <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
            ...
            <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl md:mb-6">General overviewer asdfasf</h2>
            <div class="grid grid-cols-2 gap-6 border-b border-t border-gray-200 py-4 dark:border-gray-700 md:py-8 lg:grid-cols-4 xl:gap-16">
                <div>
                    ...
                    <h3 class="mb-2 text-gray-500 dark:text-gray-400">Data Siswa</h3>
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-gray-500 dark:text-gray-400">Data Pembimbing</h3>
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-gray-500 dark:text-gray-400">Data DU/DI</h3>
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-gray-500 dark:text-gray-400">User Terdaftar</h3>
