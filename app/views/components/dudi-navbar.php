...
<nav class="bg-gray-800" x-data="{ isOpen: false }">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/dudi/kelompok" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Kelompok</a>
                        <!-- <a href="/dudi/observasi" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Observasi</a>
                        <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Penilaian</a> -->
                        <a href="/dudi/siswa" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Siswa</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
              ...
              -->
                        <div x-show="isOpen"
                            ...
                            <a href="/dudi/profile" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Profile</a>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            <a href="/dudi/kelompok" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Kelompok</a>
            ...
            <a href="/dudi/siswa" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Siswa</a>
        </div>
        <div class="border-t border-gray-700 pb-3 pt-4">
            ...
            <div class="mt-3 space-y-1 px-2">
                <a href="/dudi/profile" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white" role="menuitem" tabindex="-1" id="user-menu-item-0">Profile</a>
