            ...
            <div
                ...
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center" action="/pembimbing/siswa" method="GET">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div
                                            ...
                                            <ul
                                                ...
                                                <li>
                                                    <form action="/pembimbing/informasi-siswa" method="POST" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                        <input type="hidden" name="_method" value="DETAILM">
                                                ...
                                                <li>
                                                    <form action="/pembimbing/kegiatan" method="POST" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                        <input type="hidden" name="_method" value="SHOWM">
                                                        <input type="hidden" name="nis" value="<?= htmlspecialchars($student['nis']); ?>">
                                                        <button class="block hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Kegiatan</button>
                                                    </form>
                                                </li>
                                                <li>
                                                    <form action="/pembimbing/observasi" method="POST" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                        <input type="hidden" name="_method" value="SHOWM">
                                                        <input type="hidden" name="nis" value="<?= htmlspecialchars($student['nis']); ?>">
                                                ...
                                                <li>
                                                    <form action="/pembimbing/penilaian" method="POST" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                        <input type="hidden" name="_method" value="SHOWM">
                                                        <input type="hidden" name="nis" value="<?= htmlspecialchars($student['nis']); ?>">
                ...
                <nav class="flex flex-col items-center py-4 mb-8">
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="inline-flex -space-x-px text-sm">
                            <!-- Tombol Previous -->
                            <li>
                                <a href="<?= $currentPage > 1 ? '/pembimbing/siswa?page=' . ($currentPage - 1) . '&search=' . htmlspecialchars($search) : '#' ?>"
                            ...
                            if ($totalPages <= 2) {
                                ...
                                for ($page = 1; $page <= $totalPages; $page++) {
                                    echo '<li>
                    <a href="/pembimbing/siswa?page=' . $page . '&search=' . htmlspecialchars($search) . '"
                    ...
                    ' . $page . '
                            ...
                            <!-- Tombol Next -->
                            <li>
                                <a href="<?= $currentPage < $totalPages ? '/pembimbing/siswa?page=' . ($currentPage + 1) . '&search=' . htmlspecialchars($search) : '#' ?>"
