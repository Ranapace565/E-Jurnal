    ...
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-8 mt-4">
        <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 border-b border-t border-gray-200 py-4 dark:border-gray-700 md:py-8 xl:gap-16">
                <a href="/siswa/kegiatan?approve=3#main">
                ...
                <a href="/siswa/kegiatan?approve=1#main">
                ...
                <a href="/siswa/kegiatan?approve=2#main">
    ...
    <nav class="flex flex-col items-center py-4 mb-8">
        ...
        <nav aria-label="Page navigation example">
            <ul class="inline-flex -space-x-px text-sm">
                <!-- Tombol Previous -->
                <li>
                    <a href="<?= $currentPage > 1 ? '/siswa/kegiatan?page=' . ($currentPage - 1) . '&search=' . htmlspecialchars($search) . '&approve=' . htmlspecialchars($approve) : '#' ?>#main"
                ...
                <?php for ($page = 1; $page <= $totalPages; $page++): ?>
                    <li>
                        <a href="/siswa/kegiatan?page=<?= $page ?>&search=<?= htmlspecialchars($search) ?>&approve=<?= htmlspecialchars($approve) ?>#main"
                ...
                <!-- Tombol Next -->
                <li>
                    <a href="<?= $currentPage < $totalPages ? '/siswa/kegiatan?page=' . ($currentPage + 1) . '&search=' . htmlspecialchars($search) . '&approve=' . htmlspecialchars($approve) : '#' ?>#main"
