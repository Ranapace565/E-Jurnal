    ...
    <div class="relative rounded-lg bg-gray-100 shadow dark:bg-gray-800">
      ...
      <div class="mb-5 grid grid-cols-1 gap-4 sm:grid-cols-2 p-4 md:p-">
        <div class="col-span-2">
            ...
            <div class="mb-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div class="col-span-2">
                ...
                <div class="relative max-w-sm">
                  ...
                  <input id="date<?= htmlspecialchars($activity['id']); ?>" name="tanggal" datepicker datepicker-format="dd-mm-yyyy" datepicker-autohide type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date" value="<?= htmlspecialchars($activity['date']); ?>" required>
          ...
          <div class="border-t border-gray-200 pt-4 dark:border-gray-700 md:pt-5 flex justify-start">
            <form action="/siswa/kegiatan" method="POST" class="mt-4">
              <input type="hidden" name="_method" value="DELETE">
              <input type="hidden" name="id" value="<?= htmlspecialchars($activity['id']); ?>">
              <button type="submit" class=" me-2 inline-flex items-center rounded-lg bg-red-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800 " onclick="confirm('Apakah Anda yakin ingin menghapus aktivitas ini?, kegiatan yang dihapus tidak dapat dipulihkan!')">Hapus</button>
            </form>
          </div>
        </div>
      </div>
