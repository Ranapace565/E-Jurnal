<!-- <div class="col-span-full">
    <div class="mt-2 flex items-center gap-x-3 flex-col">
        <label for="file-upload">
            ...
            <img id="image" src="" alt="Default Image" class=" text-gray-300 rounded-full w-96 h-96 md:w-40 md:h-40" for="file-upload" />
            <svg id="placeholder-icon" class="size-20 text-gray-300 hidden w-40 h-40 md:w-40 md:h-40" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-slot="icon" for="file-upload">
